...
function makeInteraction(input: {
  ...
  return {
    ...
    options: {
      getFocused: vi
        .fn()
        .mockReturnValue({ name: "war-id", value: input.focused }),
...
describe("/fwa compliance war-id autocomplete", () => {
  ...
  it("prepends the ongoing war choice before historical wars", async () => {
    ...
    prismaMock.clanWarHistory.findMany.mockResolvedValue([
      {
        warId: 7002,
        warEndTime: new Date("2026-03-12T00:00:00.000Z"),
        opponentName: "Opp 2",
      },
      {
        warId: 7001,
    ...
    expect(choices).toEqual([
      ...
      { name: "7002 | ended: 03/12 | Opp 2", value: "7002" },
      { name: "7001 | ended: 03/11 | Opp 1", value: "7001" },
    ]);
  });
  ...
  it("returns deterministic top-10 choices with ongoing first, then ended wars sorted by endedAt then warId", async () => {
    ...
    prismaMock.clanWarHistory.findMany.mockResolvedValue([
      ...
      {
        warId: 7005,
        warEndTime: new Date("2026-03-09T00:00:00.000Z"),
        opponentName: "Opp 5",
      },
      {
        warId: 7006,
        warEndTime: new Date("2026-03-08T00:00:00.000Z"),
        opponentName: "Opp 6",
      },
      {
        warId: 7007,
        warEndTime: new Date("2026-03-07T00:00:00.000Z"),
        opponentName: "Opp 7",
      },
      {
        warId: 7008,
        warEndTime: new Date("2026-03-06T00:00:00.000Z"),
        opponentName: "Opp 8",
      },
      {
        warId: 7009,
        warEndTime: new Date("2026-03-05T00:00:00.000Z"),
        opponentName: "Opp 9",
      },
      {
        warId: 7010,
        warEndTime: new Date("2026-03-04T00:00:00.000Z"),
        opponentName: "Opp 10",
      },
      {
        warId: 7011,
        warEndTime: new Date("2026-03-03T00:00:00.000Z"),
        opponentName: "Opp 11",
      },
      {
        warId: 7012,
        warEndTime: new Date("2026-03-02T00:00:00.000Z"),
        opponentName: "Opp 12",
      },
    ]);
    prismaMock.warLookup.findMany.mockResolvedValue([
