...
describe("/inactive command shape", () => {
  it("registers an autocompleted clan option alongside days and wars", () => {
    ...
    const inClanOption = Inactive.options?.find((option) => option.name === "in-clan");
