...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  fwa: {
    ...
    details: [
      ...
      "After `/sync time post`, Mail and Bases checklists auto-post to `/bot-logs type:checklist channel:<channel>` when configured; manual public/private snapshots still work.",
