...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  "clan": {
    ...
    details: [
      ...
      "`configure` upserts tracked clan settings (lose-style, mail channel, log channel, leader channel, clan role, clan badge emoji, short name).",
