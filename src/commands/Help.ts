...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  "clan": {
    ...
    details: [
      ...
      "`rep add`, `rep remove`, and `rep list` manage tracked clan rep assignments one row at a time; `rep list` groups assignments by assigned tracked clan, includes tracked clans with no reps, and uses the shared account row renderer.",
