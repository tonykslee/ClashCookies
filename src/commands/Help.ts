...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  warplan: {
    ...
    details: [
      ...
      "For FWA, omitting `outcome` applies the same plan text to both WIN and LOSE.",
      "`show` supports all plans, one match type, or one FWA outcome.",
    ...
    examples: [
      ...
      "/warplan show match-type:FWA outcome:LOSE",
      "/warplan reset",
      "/warplan reset match-type:MM",
      "/warplan reset match-type:FWA outcome:WIN",
    ],
  },
  accounts: {
