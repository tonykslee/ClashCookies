...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  fwa: {
    ...
    details: [
      ...
      "`/fwa police` configures automatic warplan-violation enforcement per tracked clan with independently controlled DM alerts and clan-channel logs.",
    ...
    examples: [
      ...
      "/fwa police clan-tag:2QG2C08UP enable-dm:true enable-log:true",
