...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  fwa: {
    ...
    examples: [
      ...
      "/fwa police show clan:2QG2C08UP violation:EARLY_NON_MIRROR_TRIPLE",
      "/fwa police show-default clan:2QG2C08UP violation:ANY_3STAR",
      "/fwa police show-all clan:2QG2C08UP",
      "/fwa police set clan:2QG2C08UP violation:STRICT_WINDOW_MIRROR_MISS_WIN template:{offender} follow mirror plan; user={user}",
