...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  fwa: {
    ...
    details: [
      ...
      "`/fwa weight-health` summarizes persisted catalog dates for all tracked clans and flags stale weight submissions (outdated >7d, severe >=30d); use its Weight Submission Zones button for the separate 4/6-week FWA timing view. Both views perform no live FWAStats request.",
