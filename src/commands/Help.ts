...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  warplan: {
    summary: "Manage custom war plans by match type and FWA outcome.",
    details: [
      "`set` saves custom text for BL/MM, or FWA WIN/LOSE plans.",
    ...
    examples: [
      "/warplan set match-type:BL plan-text:Everyone switch to war base.",
      "/warplan set match-type:FWA outcome:WIN plan-text:Mirror 3 then cleanup 2.",
      "/warplan set match-type:FWA outcome:LOSE lose-style:TRIPLE_TOP_30 plan-text:Top 30 only.",
      "/warplan set match-type:FWA plan-text:Follow mail instructions.",
      "/warplan show",
      "/warplan show match-type:FWA",
      "/warplan show match-type:FWA outcome:LOSE lose-style:TRADITIONAL",
      "/warplan reset",
      "/warplan reset match-type:MM",
      "/warplan reset match-type:FWA outcome:LOSE lose-style:TRIPLE_TOP_30",
    ],
  },
  accounts: {
