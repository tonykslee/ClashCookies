...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  compo: {
    ...
    details: [
      ...
      "`heatmapref`: renders the persisted HeatMapRef table as an attached PNG image, including the contributing-clan count column, without triggering any rebuild/update work.",
