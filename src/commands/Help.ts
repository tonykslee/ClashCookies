...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  fwa: {
    ...
    details: [
      ...
      "Use `/fwa match-checklist type:Mail visibility:public` to post the persistent reaction-driven mail checklist version with reactions; `visibility:private` renders an ephemeral snapshot without reactions. `type:Bases` renders a read-only bases checklist snapshot or pinned post with no reactions.",
