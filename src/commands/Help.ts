...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  roster: {
    ...
    details: [
      ...
      "`/roster manage roster:<roster> action:<add|move|remove|set_weight|open|close|archive> ...` is the roster-keyed manager surface for mutation, manual fallback weight entry, and lifecycle changes.",
