...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  roster: {
    summary: "Create, list, post, and manage persisted roster signups.",
    details: [
      "`/roster create clan:<trackedCwlClanTag> [timezone:<ianaTz>]` creates a CWL signup roster seeded with Confirmed and Substitute groups. Posting is now separate, so the roster is created first and posted later with `/roster post`.",
      "`/roster list` shows roster title, type, clan scope, lifecycle state, and posted/unposted status for the guild.",
    ...
    examples: [
      ...
      "/roster edit roster:roster_123 title:CWL Alpha Signup",
