...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  "clan-health": {
    ...
    details: [
      ...
      "Tracked Clan Health results provide a first ephemeral action row with View Inactive, View Unlinked, View Compo, View Violations, and War History, plus a second row with View Trends; each opens a clan-scoped workflow with its permission target. Omitted window drilldowns use the latest 30 sync numbers; an explicit 7-to-180 window uses days. War History shows persisted ended wars, newest first, with the latest 10 displayed; Trends shows captured sync-boundary readiness history. External clan views do not include these buttons.",
