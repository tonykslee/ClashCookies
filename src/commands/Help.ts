...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  warplan: {
    ...
    details: [
      ...
      "`set/show/reset` manage clan custom plans.",
    ...
    examples: [
      ...
      "/warplan set-default match-type:BL plan-text:Everyone switch to WAR BASES!!",
      "/warplan show-default",
      "/warplan reset-default match-type:FWA outcome:LOSE lose-style:TRADITIONAL",
    ],
  },
  accounts: {
