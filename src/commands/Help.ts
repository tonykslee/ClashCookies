...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  fwa: {
    ...
    details: [
      ...
      "Use `/fwa match-checklist visibility:public` to post the persistent reaction-driven checklist version with reactions; `visibility:private` renders an ephemeral snapshot without reactions.",
      "Public checklist posts are auto-pinned, include a Refresh button, and can be refreshed to rebuild the current match state while preserving badge reactions.",
    ...
    examples: [
      ...
      "/fwa match-checklist visibility:public",
      "/fwa match-checklist visibility:private",
