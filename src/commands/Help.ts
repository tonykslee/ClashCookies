...
const COMMAND_DOCS: Record<string, CommandDoc> = {
  ...
  cwl: {
    ...
    details: [
      ...
      "`/cwl signup clan:<tag> [timezone:<ianaTz>]` posts a CWL signup roster with Confirmed and Substitute buttons; each button signs up all of your linked player accounts for that group from the posted roster message.",
