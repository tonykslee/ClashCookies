...
|------------- | ------------- | -------------|
|[**getPlayer**](#getplayer) | **GET** /players/{playerTag} | Get player information|
|[**verifyToken**](#verifytoken) | **POST** /players/{playerTag}/verifytoken | Verify player API token that can be found from the game settings.|
...
let playerTag: string; //Tag of the player. (default to undefined)
...
|------------- | ------------- | ------------- | -------------|
| **playerTag** | [**string**] | Tag of the player. | defaults to undefined|
...
# **verifyToken**
> VerifyTokenResponse verifyToken(body)
...
let playerTag: string; //Tag of the player. (default to undefined)
let body: VerifyTokenRequest; //Request body
