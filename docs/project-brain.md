...
- Read-only CWL alliance activity reporting: `CwlEventInstance / CwlEventClan / CwlRoundHistory / CurrentCwlRound / CurrentCwlPrepSnapshot / CwlPlayerClanSeason / ClanWarHistory / ClanWarParticipation / TrackedClan / CwlTrackedClan -> CwlAllianceActivityService`; the service derives deterministic report cohorts without writes, external API calls, baseline reads, or ownership changes.
