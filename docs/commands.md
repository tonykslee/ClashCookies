...
- `/link list clan-tag:<clanTag>` - Render an embed roster of linked players in compact line format (`TH | Player | <@discordUserId>`) with tracked-clan dropdown switching and deterministic ordering.
