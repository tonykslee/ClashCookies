...
- `/link list clan-tag:<clanTag>` - Render an embed roster for the clan split into linked and unlinked players (table-style fields + tracked-clan dropdown switcher; deterministic ordering).
