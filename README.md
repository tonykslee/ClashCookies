...
- `/fwa weight-age`, `/fwa weight-link`, and `/fwa weight-health` now provide FWA Stats weight-age monitoring with cached scraping, stale-weight flags, all-tracked-clan summaries, and optional authenticated scraping via `FWASTATS_WEIGHT_COOKIE`.
