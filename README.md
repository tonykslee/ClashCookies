...
- Includes `/sync readiness` for posting the shared FWA readiness dashboard, plus `/sync time post` for sync-time announcements that share the same readiness renderer.
