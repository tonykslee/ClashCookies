...
- When the points site is stale or unavailable, `/fwa match` retains each independently attributed resolver balance: complete safe balances are labeled Estimated/Persisted, unresolved finite balances are labeled Last known, history incomplete, and missing sides remain unavailable. Diagnostic or partial balances never produce a winner, enable Send Mail, or become persisted current points.
