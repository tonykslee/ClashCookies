...
- Manual Mail/Bases checklist refresh keeps the public `Refresh` control enabled, bounds preparation and the user-visible write wait to 30 seconds, and serializes concurrent refreshes per guild/message while allowing other checklist posts to proceed.
